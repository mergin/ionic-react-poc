...
- [ ] Add unit tests for i18n provider and weather mapping utilities.
- [ ] Add accessibility specs for social, gallery, and weather pages.
...
- [ ] Add CI workflow for lint, test, build, and perf smoke.
