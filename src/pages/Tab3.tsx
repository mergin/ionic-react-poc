...
function buildFallbackWeatherData(cityName: string, selectedUnit: Unit): {
...
function iconUrl(iconCode: string | undefined): string {
            ...
            <>
              <section className="current-weather">
                ...
                <p className="current-weather__meta">
                  {t('weather.wind')}: {current.wind.speed.toFixed(1)} {isFahrenheit ? 'mph' : 'm/s'}
                </p>
                <p className="current-weather__meta">
